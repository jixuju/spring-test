...
@Slf4j
@Service
public class EhCacheCacheUserService {
    @Autowired
    private UserMapper userMapper;

    @CachePut(cacheNames="EhUser", key = "#user.id.toString()")
    ...
    @Cacheable(cacheNames="EhUser", key = "#id.toString()")
    ...
    @CacheEvict(cacheNames="EhUser", key = "#id.toString()")
