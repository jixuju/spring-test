...
@Slf4j
@Service
public class GuavaCacheUserService {
    @Autowired
    private UserMapper userMapper;

    @CachePut(value="GuavaUser", key = "#user.id.toString()")
    ...
    @Cacheable(value = "GuavaUser", key = "#id.toString()")
    ...
    @CacheEvict(value = "GuavaUser", key = "#id.toString()")
